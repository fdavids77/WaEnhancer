...
class FeatureLoader {
    ...
    companion object {
        ...
        const val CLONE_PREFIX = "com.whatsapp.clone"

        @JvmStatic
        fun isWhatsAppPackage(packageName: String): Boolean {
            return packageName == PACKAGE_WPP ||
                    packageName == PACKAGE_BUSINESS ||
                    packageName.startsWith(CLONE_PREFIX)
        }

        @JvmStatic
        fun isWppOrClone(packageName: String): Boolean {
            ...
            XposedHelpers.findAndHookMethod(
                ...
                object : XC_MethodHook() {
                    override fun beforeHookedMethod(param: MethodHookParam) {
                        ...
                        val resIdArray = if (isWppOrClone(application.packageName))
